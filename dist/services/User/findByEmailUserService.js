...
const findByEmailRepositories_1 = __importDefault(require("../../repositories/User/findByEmailRepositories"));
const findByEmailUserService = (email) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (0, findByEmailRepositories_1.default)(email);
    return user;
});
