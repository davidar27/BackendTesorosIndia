...
const getProductRepository_1 = require("../../repositories/cart/getProductRepository");
const cartMiddleware = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const productId = req.body.productId || req.params.productId;
    const quantity = req.body.quantity;
    try {
        const product = yield (0, getProductRepository_1.getProductRepository)(productId);
        if (product.length === 0) {
