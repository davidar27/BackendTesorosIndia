...
import { getContentReserveNotification } from "@/helpers/Email/getContentNotification";
...
export const reserveService = async (reserve: Reserve) => {
    ...
    let content = await getContentReserveNotification("entrepreneur", "General", entrepreneur.user_id)
    ...
    content = await getContentReserveNotification("client", "General", client.usuario_id)
